...
const selected_condition_1 = __importDefault(__nccwpck_require__(9901));
/**
...
async function run() {
    try {
        ...
        const match = new selected_condition_1.default(conditions, defaultString);
...
class Selection {
    conditions;
    defaultString;
    _regex = /true\s*=>\s*([\s\S]*?)(?=(true|false)\s*=>|$)/g;
    matchString;
    constructor(conditions, defaultString) {
    ...
    parseCondition() {
        ...
        return (0, common_tags_1.stripIndent) `${returnValue}`;
    }
}
